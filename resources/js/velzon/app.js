...
(function () {
    ...
    function getImageUrl(imageName) {
        const url = `../../velzon/images/${imageName}`
        const newUrl = new URL(url, import.meta.url)
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            if (lang == "en") {
                document.getElementById("header-lang-img").src = getImageUrl("flags/us.svg");
            } else if (lang == "sp") {
                document.getElementById("header-lang-img").src = getImageUrl("flags/spain.svg");
            } else if (lang == "gr") {
                document.getElementById("header-lang-img").src = getImageUrl("flags/germany.svg");
            } else if (lang == "it") {
                document.getElementById("header-lang-img").src = getImageUrl("flags/italy.svg");
            } else if (lang == "ru") {
                document.getElementById("header-lang-img").src = getImageUrl("flags/russia.svg");
            } else if (lang == "ch") {
                document.getElementById("header-lang-img").src = getImageUrl("flags/china.svg");
            } else if (lang == "fr") {
                document.getElementById("header-lang-img").src = getImageUrl("flags/french.svg");
            } else if (lang == "ar") {
                document.getElementById("header-lang-img").src = getImageUrl("flags/ae.svg");
            }
    ...
    function twoColumnMenuGenerate() {
        ...
        if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
            ...
            const logoSm = getImageUrl("logo-sm.png")
    ...
    function toggleHamburgerMenu() {
        ...
        sessionStorage.setItem("data-sidebar-size", document.documentElement.getAttribute("data-sidebar-size"));
    }
                ...
                Array.from(document.querySelectorAll("#notificationItemsTabContent .tab-pane")).forEach(function (elem) {
                    if (elem.querySelectorAll(".notification-item").length > 0) {
                        ...
                        if (!emptyNotificationElem) {
                            const bellImg = getImageUrl("svg/bell.svg")
                            elem.innerHTML += `<div class="empty-notification-elem">\
							<div class="w-25 w-sm-50 pt-3 mx-auto">\
								<img src="${bellImg}" class="img-fluid" alt="user-pic">\
							</div>\
    ...
    function hideShowLayoutOptions(dataLayout) {
        if (dataLayout == "vertical") {
            ...
            updateHorizontalMenus();
            if (document.getElementById("theme-settings-offcanvas")) {
                if(document.getElementById("sidebar-size")) {
                ...
                if(document.getElementById("layout-position")) {
                    document.getElementById("layout-position").style.display = "block";
                }
                if(document.getElementById("layout-width")) {
                    document.getElementById("layout-width").style.display = "block";
                }
                if(document.getElementById("sidebar-visibility")) {
                    document.getElementById("sidebar-visibility").style.display = "none";
                }
            }
            initActiveMenu();
    ...
    function setCookie(name, value) {
        const cookieName = `sunny-crm-theme-${name}`
        const cookie = `${encodeURIComponent(cookieName)}=${encodeURIComponent(value)}`
        ...
        document.cookie = `${cookie}${expires}${pathString}`
    }
